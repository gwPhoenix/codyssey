...
file_copy.txt
permission_test
na908158800@c3r1s4 ~ % ls -la   #폴더와 파일 목록 확인(숨김파일 포함)
total 968
...
na908158800@c3r1s4 ~ % ls -la   #폴더와 파일 목록 확인(숨김파일 포함) ▶︎ 파일이 이동되어 목록에 없음
total 968
...
na908158800@c3r1s4 test_dir % ls -la   #폴더와 파일 목록 확인(숨김파일 포함)
total 8
...
na908158800@c3r1s4 test_dir % ls -la   #폴더와 파일 목록 확인(숨김파일 포함) ▶︎ 파일 삭제되어 목록에 없음
total 0
